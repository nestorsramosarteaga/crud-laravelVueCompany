...
<template>
    ...
    <AuthenticatedLayout>
                ...
                <table class="table-auto border border-gray-400">
                    ...
                    <tbody>
                        <tr v-for="emp, i in employees.data" :key="emp.id">
                            <td class="border border-gray-400 px-2 py-2">{{ getIndex(i+1) }}</td>
        ...
        <Modal :show="modal" @close="closeModal">
            <div class="flex flex-col justify-center pl-4 mb-4">
                ...
                <div class="p-1">
                    ...
                    <SelectInput 
                        id="department_id" :options="departments" 
